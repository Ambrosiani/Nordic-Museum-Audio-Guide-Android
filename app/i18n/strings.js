export const strings = {
    en: {
      ...
      aboutScreen_AdmissionBody1: '• Adult, senior citizen and student: 120 SEK (free admission Tuesday, 13-17 September-May)',
      aboutScreen_AdmissionBody2: '• Children and adolescents up to 18 years: free entrance',
      aboutScreen_AdmissionBody3: '• Lekstugan: Children 20 SEK (included for adults in admission fee to the museum)',
      ...
      aboutTheAppAudioContentBody: 'The audio content in the app has been recorded over at least twenty years. Recent additions have been recorded by Eskimo Avenue and H Olsson Ord & Vision with Robert Ziherl as project manager at the Nordic Museum. The highlights are produced by H Olsson Ord & Vision together with project managers Lena Landerberg and Robert Ziherl at the Nordic Museum.\n\nThe music in the app is from the musical history collection Musica Sveciae which is administrated by The Royal Swedish Academy of Music.',
      aboutTheAppTheAppHeader: 'The App',
      aboutTheAppTheAppBody: 'The Nordic Museum Audio Guide for Android is based on an open source project by students at the Royal School of Technology (KTH) in Stockholm. This app is an expanded and modified version. The app is released as open source.',
      aboutTheAppProjectManagerNordicMuseumHeader: 'Project manager',
      aboutTheAppDevelopmentAndDesignHeader: 'Development and Design',
      aboutTheAppDocumentationHeader: 'Documentation' ,
      ...
      '378': 'Visual description 0: Welcome (in Swedish)',
      '379': 'Visual description 1: Woman 1780 (in Swedish)',
      '380': 'Visual description 2: Boy 1765 (in Swedish)',
      '381': 'Visual description 3: Woman 1810 (in Swedish)',
      '382': 'Visual description 4: Woman 1860 (in Swedish)',
      '383': 'Visual description 5: Man 1860 (in Swedish)',
      '384': 'Visual description 6: Woman 1860 (in Swedish)',
      '385': 'Visual description 7: Woman 1925 (in Swedish)',
      '386': 'Visual description 8: Man 1922 (in Swedish)',
      '387': 'Visual description 9: Woman 1943 (in Swedish)',
      '388': 'Visual description 10: Woman 1950 (in Swedish)',
      '389': 'Visual description 11: Teenager 1958 (in Swedish)',
      '390': 'Visual description 12: Man 1970 (in Swedish)',
      '391': 'Visual description 13: Woman 2009 (in Swedish)',
      ...
      '433': 'Who came first?',
      '434': 'The Reindeer',
      '435': 'Interview: Lars-Marcus Kuhmunen (in Swedish)',
      '436': 'Interview: Elias Torkelsson (in Swedish)',
      '437': 'Interview: Victoria Harnesk (in Swedish)',
      '438': 'Interview: Inge Frisk (in Swedish)',
      '439': 'Interview: Linda Mannela (in Swedish)',
      '440': 'Interview: Lis-Maria Hjortfors (in Swedish)',
      '441': 'Interview: Lotta Willborg Stoor (in Swedish)',
      '442': 'Interview: Per-Gustav Idivuoma (in Swedish)',
      '443': 'Interview: Staffan Palopaa (in Swedish)',
      '444': 'Interview: Sylvia Simma (in Swedish)',
      '445': 'Whose rights?',
      '446': 'Sami crafts',
      ...
      '469': 'The Textile Gallery',
      '470': 'Twined knitting against the Nordic cold',
      '471': 'Indian chintz in the Stockholm archipelago',
      '472': 'Neat lace',
      '473': 'Vivid colours from the 15th century',
      '474': 'Decorating the cottage for a feast',
      '475': 'Embroidery with biblical motifs',
      '476': 'Rags and tatters',
  
      //6. TRANSCRIPTS
      
      //7. Error alerts
      interruptedDownload: "The download of the language package was interrupted. Go to Info -> Language and choose a language to re-download a language package.",
    },
    sv: {
      // 1. IN-APP STRINGS
      min: 'min',
      ...
      aboutTheAppAudioContentBody: 'Ljudinnehållet i appen har spelats in under åtminstone tjugo år. Senare tillägg har spelats in av Eskimo Avenue och H Olsson Ord & Vision med Robert Ziherl som projektledare på Nordiska museet. Höjdpunkterna är producerade av H Olsson Ord & Vision i samarbete med Lena Landerberg och Robert Ziherl som projektledare på Nordiska museet.\n\nMusiken i appen kommer från den musikhistoriska serien Musica Sveciae som administreras av Kungl. Musikaliska Akademien.',
      aboutTheAppTheAppHeader: 'Appen',
      aboutTheAppTheAppBody: 'Nordiska museets audioguide för Android bygger på ett projekt gjort av studenter vid Kungliga Tekniska Högskolan (KTH) i Stockholm. Den här appen är en utökad och modifierad version. Appen finns tillgänglig som öppen källkod.',
      aboutTheAppProjectManagerNordicMuseumHeader: 'Projektledare',
      aboutTheAppDevelopmentAndDesignHeader: 'Utveckling och design',
      aboutTheAppDocumentationHeader: 'Dokumentering' ,
      ...
      aboutScreen_HoursHeader: 'Opening Hours',
      aboutScreen_HoursBody1: 'Juni-August: dagligen kl 9-18',
      aboutScreen_HoursBody2: 'September-Maj: dagligen kl 10-17',
      aboutScreen_AdmissionHeader: 'Entré',
      aboutScreen_AdmissionBody1: '• Vuxen, pensionär och student: 120 kr (fri entré tisdag kl. 13–17 september–maj)',
      aboutScreen_AdmissionBody2: '• Barn och ungdomar till och med 18 år: fri entré',
      aboutScreen_AdmissionBody3: '• Lekstugan: Barn 20 kr (ingår för vuxna i entréavgift till museet)',
      ...
      '441': 'Intervju: Lotta Willborg Stoor',
      ...
      '460': 'Folkkonst idag',
      '469': 'Skatter av tyg',
      '470': 'Tvåändsstickning mot nordisk kyla',
      '471': 'Indisk kattun i Stockholms skärgård',
      '472': 'Prydlig spets',
      '473': 'Klara färger från 1400-talet',
      '474': 'Klä stugan till fest',
      '475': 'Broderier med bibliska motiv',
      '476': 'Trasor och lump',
  
      //6. TRANSCRIPTS

      //7. Error alerts
      interruptedDownload: "Nedladdningen av språkpaket avbröts. Gå till Info -> Språk och välj ett språk för att ladda ner ett språkpaket.",
    ...
    de: {
      ...
      // 3. AMENITIES
      amenities_CloakroomTitle: 'Garderobe',
      amenities_ToiletsTitle: 'Toiletten',
      amenities_BabyChangingTablesTitle: 'Wickeltische für Babys',
      amenities_PackedLunchRoomTitle: 'Lunchpaket Zimmer',
      amenities_PlayAreaTitle: 'Spielplatz',
      amenities_LibraryAndArchiveTitle: 'Library and Archive',
      amenities_AssemblyHallTitle: 'Assembly Hall',
      amenities_WheelchairPushchairEntranceTitle: 'Wheelchair/pushchair entrance',
      amenities_InformationTitle: 'Information',
